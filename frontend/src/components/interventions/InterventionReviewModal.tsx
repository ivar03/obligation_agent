  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl flex flex-col">
        {/* Modal Header */}
        <div className="p-6 border-b border-zinc-800 flex items-center justify-between sticky top-0 bg-zinc-900/95 backdrop-blur-md z-10">
          <div>
        ...
        <div className="p-6 space-y-5 flex-1">
            ...
            <div className="bg-zinc-950/60 border border-zinc-800/80 rounded-xl p-3.5">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="bg-zinc-900 border border-zinc-700 rounded-lg px-2.5 py-1 text-sm text-white focus:outline-none focus:border-blue-500 w-full"
                />
              </div>
            </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-xs text-zinc-400 hover:text-blue-400 transition-colors inline-flex items-center gap-1"
            ...
            <textarea
              ...
              className="w-full bg-zinc-950 border border-zinc-700 rounded-xl p-3.5 text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-blue-500 leading-relaxed font-sans"
          ...
          <div className="border border-zinc-800 rounded-xl overflow-hidden">
            <button
              ...
              className="w-full p-3.5 bg-zinc-950 flex items-center justify-between text-xs font-semibold text-zinc-300 hover:bg-zinc-800/50 transition-colors"
            >
            ...
            {showScheduleInput && (
              <div className="p-4 bg-zinc-900/50 border-t border-zinc-800 space-y-3">
                ...
                <input
                  ...
                  className="bg-zinc-950 border border-zinc-700 rounded-xl px-3 py-2 text-sm text-zinc-100 focus:outline-none focus:border-purple-500"
                />
              </div>
            )}
          </div>
          ...
          <div className="border border-zinc-800 rounded-xl overflow-hidden">
            ...
            {showContextDetails && (
              <div className="p-4 bg-zinc-900/50 border-t border-zinc-800">
                <pre className="text-xs text-zinc-300 overflow-x-auto bg-zinc-950 p-3 rounded-lg border border-zinc-800 font-mono">
        ...
        <div className="p-5 border-t border-zinc-800 bg-zinc-900/95 flex flex-wrap items-center justify-between gap-3 sticky bottom-0 z-10">
          <button
            type="button"
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              disabled={submitting}
              className="px-3.5 py-2 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-200 text-xs font-semibold transition-colors disabled:opacity-50"
            >
              Save Draft
            </button>
            ...
            {showScheduleInput && scheduledFor ? (
              <button
                ...
                disabled={submitting}
                className="px-4 py-2 rounded-xl bg-purple-600 hover:bg-purple-500 text-white text-xs font-semibold transition-all shadow-md shadow-purple-600/20 active:scale-95 disabled:opacity-50 flex items-center gap-1.5"
              >
              ...
              <>
                <button
                  ...
                  disabled={submitting}
                  className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold transition-all shadow-md shadow-emerald-600/20 active:scale-95 disabled:opacity-50 flex items-center gap-1.5"
                >
                ...
                <button
                  ...
                  disabled={submitting}
                  className="px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold transition-all shadow-md shadow-blue-600/20 active:scale-95 disabled:opacity-50 flex items-center gap-1.5"
                >
