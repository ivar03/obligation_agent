    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-stone-200 pb-5">
        ...
        <div className="flex items-center gap-3">
          <div className="p-3 rounded-xl bg-stone-100/80 border border-stone-200 text-xs flex items-center gap-3">
            ...
            <button
              ...
              disabled={verifying}
              className="p-1.5 rounded bg-stone-200 hover:bg-stone-300 text-stone-700 transition-colors"
      ...
      {/* Filter Bar */}
      <div className="bg-stone-100/60 border border-stone-200 rounded-xl p-4 flex flex-wrap items-center gap-3">
        ...
        <select
          ...
          className="bg-stone-50 border border-stone-300 rounded-lg px-2.5 py-1.5 text-xs text-stone-800 focus:outline-none"
        >
      ...
      {/* Audit Records Table */}
      <div className="bg-stone-100/60 border border-stone-200 rounded-xl overflow-hidden">
          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-stone-200/60 font-mono text-[11px]">
              {loading ? (
                ...
                records.map((r) => (
                  <tr key={r.id} className="hover:bg-stone-200/30 transition-colors">
                    <td className="p-3 text-stone-600">{new Date(r.timestamp).toLocaleTimeString()}</td>
                    ...
                    <td className="p-3 text-stone-500">{r.record_hash.slice(0, 12)}...</td>
                    <td className="p-3 text-right">
                      <button
                        onClick={() => setSelectedRecord(r)}
                        className="p-1 rounded hover:bg-stone-200 text-stone-600 hover:text-stone-800 transition-colors"
      ...
      {selectedRecord && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-stone-100 border border-stone-200 rounded-xl max-w-2xl w-full p-6 space-y-4 shadow-2xl">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs font-mono bg-stone-50 p-3 rounded-lg border border-stone-200">
              ...
              <div>
                ...
                <span className="text-blue-500">{selectedRecord.trace_id || "None"}</span>
              </div>
            </div>
            ...
            <div>
              ...
              <pre className="bg-stone-50 p-3 rounded-lg text-xs font-mono text-emerald-400 overflow-x-auto max-h-60 border border-stone-200">
