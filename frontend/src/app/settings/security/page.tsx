  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
        <div className="p-5 rounded-2xl bg-stone-100 border border-stone-200 shadow-sm space-y-2">
      ...
      <div className="bg-stone-100 border border-stone-200 rounded-2xl p-6 shadow-sm space-y-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-4 py-2 bg-blue-600 hover:bg-blue-500 text-stone-950 rounded-xl text-xs font-semibold shadow transition-all"
          >
