  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-sm space-y-6">
      <div className="border-b border-zinc-800 pb-4">
        ...
        <p className="text-xs text-zinc-400 mt-0.5">Control which proactive intelligence events trigger in-app alerts.</p>
      </div>

      <div className="space-y-3 text-xs max-w-xl">
        <label className="flex items-center justify-between p-3.5 rounded-xl bg-zinc-950/50 border border-zinc-800/80 cursor-pointer">
          <div>
            <div className="font-semibold text-zinc-200">Critical Risk & Cascade Detected</div>
            <div className="text-zinc-400 text-[11px]">When an upstream blocker endangers dependent deliverables.</div>
          </div>
          <input
            type="checkbox"
        ...
        <label className="flex items-center justify-between p-3.5 rounded-xl bg-zinc-950/50 border border-zinc-800/80 cursor-pointer">
          <div>
            <div className="font-semibold text-zinc-200">Evidence Awaiting Confirmation</div>
            <div className="text-zinc-400 text-[11px]">When AI correlation suggests completion evidence for human review.</div>
          </div>
          <input
            type="checkbox"
        ...
        <label className="flex items-center justify-between p-3.5 rounded-xl bg-zinc-950/50 border border-zinc-800/80 cursor-pointer">
          <div>
            <div className="font-semibold text-zinc-200">Decision Plan Awaiting Approval</div>
            <div className="text-zinc-400 text-[11px]">When a strategic resolution plan is synthesized by the reasoning layer.</div>
          </div>
          <input
            type="checkbox"
        ...
        <label className="flex items-center justify-between p-3.5 rounded-xl bg-zinc-950/50 border border-zinc-800/80 cursor-pointer">
          <div>
            <div className="font-semibold text-zinc-200">Execution Delivery Failed</div>
            <div className="text-zinc-400 text-[11px]">When a dispatched intervention encounters rate limits or provider errors.</div>
          </div>
          <input
            type="checkbox"
      ...
      <div className="pt-2 flex items-center gap-3">
        <button
          onClick={handleSave}
          disabled={loading}
          className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white rounded-xl text-xs font-semibold shadow transition-all"
        >
